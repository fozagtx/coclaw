...
const envSchema = z.object({
  ...
  STELLAR_NETWORK: z.enum(['stellar:testnet', 'stellar:pubnet']).default('stellar:testnet'),
  STELLAR_RPC_URL: z.string().default('https://soroban-testnet.stellar.org'),
  STELLAR_USDC_CONTRACT: z.string().default('CBIELTK6YBZJU5UP2WWQEUCYKLPU6AUNZ2BQ4WWFEIE3USCIHMXQDAMA'),
